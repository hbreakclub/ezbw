...
# ========================= CONSTANTS ============================
AFKSTR = [
    f"◉ **ꜱᴏʀʀʏ {ALIVE_NAME} ʟᴀɢɪ ᴏꜰꜰ!**",
    f"◉ **{ALIVE_NAME} ᴍᴀꜱɪʜ ᴏꜰꜰ!**\n◉ **ᴊᴀɴɢᴀɴ ᴋᴀɴɢᴇɴ ᴋɪɴᴛɪʟ!**",
    f"ㅤ◉ **ꜱᴏʀʀʏ {ALIVE_NAME} ɴɢᴇᴡꜱ ᴅᴜʟᴜ!**ㅤ\nㅤ◉ **ɴᴀɴᴛɪ ɢᴜᴀ ʙᴀʟɪᴋ ʟᴀɢɪ ᴏᴋᴇ!**ㅤ",
    f"◉ **ꜱᴏʀʀʏ {ALIVE_NAME} ᴍᴀꜱɪʜ ᴏꜰꜰ!**",
]
