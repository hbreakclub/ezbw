...
PP_CHANGED = "```✓ Ava Berhasil Diubah!```"
...
NAME_OK = "```✓ Nama Berhasil Diubah!```"
USERNAME_SUCCESS = "```✓ Username Berhasil Diubah!```"
USERNAME_TAKEN = "```✗ Username Sudah Ada Yang Menggunakannya.```"
# ===============================================================
